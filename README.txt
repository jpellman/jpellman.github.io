libjpel.so uses Twenty, a jekyll theme designed by AJ.
The original git repository for this theme can be found here:

https://github.com/old-jekyll-templates/Twenty-Jekyll-Theme

Below is the theme's readme.
--------------------------------------------------------------
